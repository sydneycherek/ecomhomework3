...
<html lang="en">
  ...
  <body>
    <h1>Animals and their Enclosures</h1>
...
<?php
    $section_sql = "select e.enclosuretype from Animal a join enclosure e on a.enclosure_id = e.enclosure_id where a.enclosure_id=" . $row["enclosure_id"];
